...
const Login=()=>{
    ...
    return(
        ...
        <div onSubmit={(e)=>e.preventDefault()} className="w-3/4 md:w-3/12 absolute p-12 my-36 bg-black mx-auto right-0 left-0 text-white opacity-80">
            ...
            {!IsSignInForm && <input type="text" ref={name} placeholder="Enter Your Full Name" className="p-2 my-2 w-full bg-gray-700"/>}
            <input type="email" ref={email} placeholder="Enter Your Email" className="p-2 my-2 w-full bg-gray-700"/>
            <input type="password" ref={password} placeholder="Enter Your Password" className="p-2 my-2 w-full bg-gray-700"/>
